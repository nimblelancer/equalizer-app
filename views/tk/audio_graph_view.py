...
import wave
from views.tk.graph_factory import GraphFactory
...
#             graph_factory = GraphFactory(ax)
#             if i == 0:
#                 graph_factory.create_waveform()
#             elif i == 1:
#                 graph_factory.create_spectrogram()
#             elif i == 2:
#                 graph_factory.create_frequency_spectrum()
#             elif i == 3:
#                 graph_factory.create_volume_level()
#             elif i == 4:
#                 graph_factory.create_bar_chart()
#             elif i == 5:
#                 graph_factory.create_fft()
#             elif i == 6:
#                 graph_factory.create_frequency_response()
...
#             self.graphs.append(graph_factory)
